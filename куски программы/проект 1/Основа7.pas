  ...
  begin
    writeln('Здравствуйте! Какое действие выполнить? Если среднее арифмитеческое введите "1", если среднее геометрическое введите "2", если сравнить сумму ел-тов 2х массивов введите "3", решить квадратное ур-е введите "4", если хотите найти НОД введите "5", если рандомно заполнить массив то "6", введите 0, чтобы закончить.');
    readln(d);
    k:=d;
  end;
